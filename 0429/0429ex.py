...
'''
name=input('이름입력:') # 이름 문자열로 입력
print('내 이름은{}이고 name변수의 자료형은 {}이다'.format(name,type(name)))

age=input('나이입력:') # 나이 문자열로 입력
print('나이는{}이고 age변수의 자료형은 {}이다'.format(age,type(age)))

age2=int(input('나이 입력2:')) # 나이 정수로 입력
print('나이는{}이고 age변수의 자료형은 {}이다'.format(age2,type(age2)))
